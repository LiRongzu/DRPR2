...
def train_single_feature_som(
    ...
    # 返回结果
    results = {
        'feature_name': feature_name,  # 更新为 feature_name
...
def train_combined_feature_som(cfg: DictConfig, output_feature_name: str = "wind_flow") -> Dict[str, Any]:
    ...
    return {
        'feature_name': output_feature_name,  # 更改 'feature_type' 为 'feature_name'
        'model_path': model_path,
        'map_size': map_size,
        'training_time': training_time,
        'bmu_generation_time': bmu_generation_time,
        'bmu_paths': bmu_paths_combined
    }
...
def main(cfg: DictConfig) -> None:
    ...
    if (feature_to_train == "all"):
        ...
        results = train_combined_feature_som(cfg)
    else:
